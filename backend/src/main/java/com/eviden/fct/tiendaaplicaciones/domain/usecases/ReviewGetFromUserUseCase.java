...
@Component
public class ReviewGetFromUserUseCase {
	...
	public Review invoke(Long contentId) throws NotFoundException {	
		...
		try {
			...
			return reviewService.getByUserAndContent(user, content);
